"""
14 - Password Hashing and Verification

Description:
This program hashes a user password using the MD5 algorithm,
stores the hash in a file, and verifies the password by
comparing the entered password's hash with the stored hash.
