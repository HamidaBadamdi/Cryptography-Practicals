"""
11 - RSA Sender (Encryption)

Description:
This program demonstrates RSA encryption using the receiver's public key.
It accepts a message from the user, encrypts it with OAEP padding, and
stores the encrypted message in a binary file.
